...
const links = [
  { name: "Thoughts and portfolio", url: "https://robhutters.com" },
  { name: "Contact me on Reddit", url: "https://reddit.com/u/robhutters" },
  { name: "Contact me on BlueSky", url: "https://bsky.app/profile/robhutters.com" },
];
    ...
    <>
      <div className={`fixed bottom-4 right-4 z-50 ${btnSize}`}>
        <div className="relative h-full w-full">
          ...
          >
            <img
              src="https://robhutters.com/assets/images/headshot/bluesky_profile.png"
      ...
      <div className={`z-50 ${panelClasses}`}>
        <div className="p-3 text-sm font-semibold text-zinc-800">About Rob</div>
